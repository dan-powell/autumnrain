...
@section('class')Static _privacy @stop
...
@section('main')
    ...
    <section class="Section Section--content Section--lg">
	    <div class="Section-container">
            ...
            <article class="Content">
                ...
                <p>The term 'Autumn Rain Studios' or 'us' or 'we' refers to the owner of the website. The term 'you' refers to the user or viewer of our website.</p>
                <p>This policy is effective from 30 Dec 2011.</p>
